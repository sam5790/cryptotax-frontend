<template>
  <div class="md:p-10">
    ...
    <div
      class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 w-30 gap-4 md:mt-3 md:p-16 md:ml-10 max-sm:mb-3 ml-5 mb-4 p-1"
    >
      <div
      ...
      >
        ...
        <div class="flex mt-4 ml-16">
          ...
          <h2 class="text-lg font-medium fontPoppins -mt-1 ml-2">
