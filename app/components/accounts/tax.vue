<template>
  <ClientOnly>
    <div class="p-4 md:p-16 bg-gray-50">
          ...
          <div
            ...
            <div class="flex flex-wrap items-center justify-between gap-2">
              <div class="flex flex-wrap items-center gap-2">
                <input type="radio" name="method" id="hifo" class="hidden peer/hifo" checked />
                <label for="hifo"
            ...
            <div class="flex flex-wrap justify-between gap-4 py-5 mt-3">
              <div>
                ...
                <span class="text-green-700 text-2xl font-bold mt-2 font-[Poppins]">$0</span>
              </div>
              <div v-if="total_pnl[0]?.totalPnl > 0">
                <p class="text-sm text-[#949494]">Capital Gain</p>
                <span class="text-green-700 text-2xl font-bold font-[Poppins] flex gap-1">
              ...
              <div v-else>
                ...
                <span class="text-red-600 text-2xl font-bold font-[Poppins] flex gap-1">
      ...
      <div class="lg:p-8 flex flex-col justify-center items-center w-full" v-if="pnl.length > 0">
        ...
        <div class="w-full hidden sm:hidden md:block overflow-x-auto">
          <div class="flex justify-between md:px-6 md:py-3 bg-none">
            ...
            <div class="relative inline-block text-left">
              <button @click="openChooseAccount = !openChooseAccount"
                ...
                <div class="flex items-center gap-3">
                  <img v-if="selectedAccount" :src="`/icons/${selectedAccount.toLowerCase()}.png`"
                    :alt="selectedAccount" class="h-8 w-8 rounded-full" />
              ...
              <div v-if="openChooseAccount"
                ...
                <ul class="text-sm text-gray-700 max-h-60 overflow-y-auto">
                  <li v-for="exchange in taxPagination?.exchanges" :key="exchange" @click="getExchangeData(exchange)"
        ...
        <div class="w-full sm:w-full md:hidden space-y-4 px-2">
          <div class="flex justify-between md:px-6 md:py-3 gap-3 bg-none flex-wrap">
            <ClientOnly>
              <DownloadExcel class="btn btn-primary" :data="pnl" :fields="excelFields" name="pnl.xls">
                <button
          ...
          <div v-for="(item, index) in pnl" :key="index" class="p-4 rounded-xl shadow-md bg-white border">
            <div class="flex justify-between mb-2 flex-wrap">
              <span class="font-semibold font-[Poppins]">#{{ index + (taxPagination?.currentPage - 1) * 50 + 1 }}</span>
