      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
        ...
        >
          ...
          <div class="flex mt-2 items-center">
            <img
              v-for="exchange in transactionsPagination?.exchanges?.slice(0, 3)"
              :key="exchange"
          ...
          <div class="relative inline-block text-left">
            ...
            >
              <ul class="text-sm text-gray-700 max-h-60 overflow-y-auto">
                <li
                  v-for="exchange in transactionsPagination?.exchanges"
                  :key="exchange"
      ...
      <div class="w-full sm:w-full md:hidden space-y-4 px-2">
        ...
        >
          ...
          <div class="flex justify-between my-1">
            ...
            <span class="text-green-700 flex items-center gap-1 font-[Poppins]"
              ><Icon name="mdi:menu-up" class="w-8 h-8" />{{ item.buyPrice }} (
              <NuxtTime
                :datetime="item.buyDate"
                month="short"
          ...
          <div class="flex justify-between my-1">
            ...
            <span class="text-red-600 flex items-center gap-1 font-[Poppins]"
