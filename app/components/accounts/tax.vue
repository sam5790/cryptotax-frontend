            ...
            <div class="flex flex-wrap justify-between gap-4 py-5 mt-3">
              ...
              <div v-else-if="taxPagination?.pnlSum > 0">
                ...
                >
                  ...
                  {{ taxPagination?.pnlSum?.toFixed(2) }}
                </span>
              </div>
              <div v-else>
          ...
          <table class="w-full text-left">
              ...
              <tr class="text-gray-500">
                ...
                <th class="py-2 px-4 border-b font-semibold relative">
                  <div
                    ...
                    :class="openCoinFilter ? 'text-[#4AABAB]' : ''"
                  >
                    Coin
                    <Icon
                  ...
                  >
                    <div
                      class="px-1 py-2 flex items-center justify-center gap-2 max-w-full"
                    >
                      <input
                        v-model="searchCoin"
                        type="text"
                    ...
                    >
                      ...
                      <Icon
                        ...
                        class="cursor-pointer text-gray-500 hover:text-[#4AABAB] shrink-0"
                    ...
                    <ul class="text-sm text-gray-700 max-h-48 overflow-y-auto">
                      <li
                        ...
                        :key="coin"
                        @click="getCoinData(coin)"
                        class="px-4 py-1 m-1 cursor-pointer rounded-md transition"
                        :class="
                          coin === selectedCoin
            ...
            <tbody v-else>
              <tr v-for="(item, index) in pnl" :key="index" class="border-b">
                ...
                <td
                  class="py-4 px-4 capitalize font-[Poppins] whitespace-nowrap"
                >
                  <NuxtTime
        ...
        <div class="w-full sm:w-full md:hidden space-y-4 px-2">
          <div class="flex justify-between gap-3 bg-none flex-wrap">
            ...
            <div class="flex items-center gap-2 flex-wrap">
              <div
                class="shadow-[0_0_10px_0] shadow-[#254BD34D] rounded-lg px-3 py-3 border border-gray-50 font-semibold relative"
              >
                <div
                  class="flex items-center gap-1"
                  :class="openCoinFilter ? 'text-[#4AABAB]' : ''"
