<template>
  <div>
    <div class="flex flex-col sm:flex-row justify-center items-center gap-6 p-5 flex-wrap">
      <div class="shadow-2xl p-6 text-center rounded-2xl relative w-full sm:w-64 h-28">
      ...
      <div class="shadow-2xl p-6 text-center rounded-2xl relative w-full sm:w-64 h-28 mt-2 sm:mt-0">
        <div class="absolute -top-6 left-1/2 -translate-x-1/2 bg-white shadow-lg w-12 h-12 rounded-full flex items-center justify-center">
    ...
    <div class="container bg-white mx-auto w-full md:p-7 shadow-lg md:my-8">
