  ...
  <div class="p-5 bg-gray-50 h-auto">
      ...
      <div class="flex">
        <button
          ...
          :class="[
            'px-6 py-2 text-sm font-semibold  transition-all duration-200',
            activeTab === tab.id
              ? 'border-b-2 border-[#4aabab] text-[#4aabab] ease-in-out'
              : 'text-gray-500 hover:text-[#4aabab]',
          ]"
        >
          {{ tab.name }}
        </button>
...
<Transition name="fade" mode="out-in">
  <div v-if="activeTab === 'transactions'">
      ...
      <h2 class="text-2xl md:text-4xl font-semibold mb-5 mt-3 text-center">
        Transactions
      </h2>
      <div
      ...
      <div class="flex justify-center gap-3 mt-6">
        <button
          @click="
            changeTransactionPage(transactionsPagination?.currentPage - 1)
          "
