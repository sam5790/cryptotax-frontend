<template>
  <div>
    ...
    <div class="w-full flex justify-center mt-6 md:mt-10 mb-12 md:mb-16">
      <div class="bg-white border border-gray-300 rounded-full flex flex-col sm:flex-row items-center w-full max-w-lg md:max-w-2xl px-4 py-2 sm:p-0">
        <input 
          type="email" 
          placeholder="Enter your email address to start your free trial"
          class="flex-1 w-full px-4 py-3 sm:py-2 rounded-full text-gray-600 text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-teal-500"
        />
        <button class="mt-3 sm:mt-0 sm:ml-4 bg-teal-600 hover:bg-teal-700 transition-colors text-white px-6 py-3 sm:py-2 rounded-full font-semibold text-sm sm:text-base whitespace-nowrap">
          Redeem Now
        </button>
      </div>
    </div>
    ...
    <div class="p-4 md:p-10">
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 max-w-7xl mx-auto">
        <div class="rounded-2xl shadow-lg md:shadow-2xl p-6 md:p-8 lg:p-10 flex flex-col">
          ...
          <button class="bg-teal-600 hover:bg-teal-700 transition-colors text-white py-3 md:py-2 rounded-full text-sm md:text-base">
            Get Started
          </button>
        </div>
        ...
        <div class="relative">
          ...
          <div class="border border-teal-500 rounded-2xl shadow-lg md:shadow-2xl p-6 md:p-8 lg:p-10 flex flex-col h-full">
            ...
            <ul class="space-y-3 mb-6 mt-4 flex-grow">
              <li class="flex items-center gap-3 text-sm md:text-base">
                <img src="/about/filled-icons-check-circle-12.svg" class="w-4 md:w-5" alt="check"> All analytics features
              </li>
              <li class="flex items-center gap-3 text-sm md:text-base">
    ...
    <div class="p-4 md:p-10">
      <div class="rounded-xl shadow-lg md:shadow-2xl p-6 md:p-10 mx-auto max-w-4xl">
        ...
        <div class="p-3 flex justify-center mt-8 md:mt-14">
          <button class="text-white bg-teal-500 hover:bg-teal-600 transition-colors rounded-full px-6 py-3 md:px-4 md:py-2 text-base md:text-xl flex items-center justify-center">
    ...
    <div class="mx-auto max-w-7xl mb-10 px-4 md:px-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 lg:gap-16">
        <div class="relative">
          <div class="absolute -top-3 left-1/2 -translate-x-1/2 bg-teal-600 text-white px-3 py-1 rounded-full text-xs md:text-sm font-semibold shadow whitespace-nowrap z-10">
            Pro Plan 2023
          </div>
          ...
          <div class="border border-teal-500 rounded-2xl shadow-lg md:shadow-2xl flex flex-col h-full">
            <div class="bg-teal-400 mt-8 p-4">
            ...
            <div class="p-4 md:p-6 flex-grow">
              <p class="text-sm md:text-base">
                A tax expert can help you optimize your crypto tax strategy and minimize liabilities. Complex crypto investments often require specialized guidance for accurate tax reporting.
              </p>
            </div>

            <div class="flex justify-center items-center p-4">
              <button class="bg-teal-600 hover:bg-teal-700 transition-colors text-white py-3 px-6 md:py-2 md:px-8 rounded-full text-sm md:text-base w-full max-w-xs">
                Book Now
              </button>
            </div>
          </div>
